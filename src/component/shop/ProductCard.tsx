...
export default function ProductCard({ product }: { product: Product }) {
 ...
 <h3 className="font-semibold text-stone-900 dark:text-stone-100 text-sm sm:text-base leading-snug mb-1 group-hover:underline line-clamp-2">
 {product.name}
 </h3>
 ...
 <div>
 <div className="text-base sm:text-lg font-bold text-stone-900 dark:text-stone-100 leading-tight">
