    ...
    <div className="mx-auto max-w-6xl px-4 py-6">
      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_360px]">
        <div className="space-y-3">
          {items.map((item) => {
            const unit = priceAfterDiscount(item.price, item.discount);
            return (
              <div
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="mt-0.5 text-xs text-gray-500">Size: {item.sizeName}</p>
                ...
                <div className="flex flex-col items-end justify-between">
                  ...
                  <div className="flex items-center gap-2 rounded-lg border border-gray-200 p-1">
                    <button
                      onClick={() =>
                        dec({ productId: item.productId, productSizeId: item.sizeId })
                      }
                    ...
                    <button
                      onClick={() =>
                        inc({ productId: item.productId, productSizeId: item.sizeId })
                      }
                      className="rounded p-1 hover:bg-gray-100"
                    >
                      <Plus size={12} />
