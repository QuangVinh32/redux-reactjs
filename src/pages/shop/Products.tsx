...
export default function Products() {
 ...
 <div className="font-serif text-lg font-semibold mb-2">Liên hệ CSKH</div>
 ...
 <h1 className="font-serif text-2xl md:text-3xl font-bold text-stone-900 dark:text-stone-100">
 {activeCategory.name}
 </h1>
