...
export default function Login() {
 ...
 <h1 className="text-2xl font-bold tracking-wide">Đăng Nhập</h1>
 ...
 className="w-full h-11 pl-10 pr-4 border-2 border-slate-200 dark:border-slate-700 focus:border-emerald-400 outline-none text-sm bg-slate-50 dark:bg-slate-800 focus:bg-white dark:focus:bg-slate-900 text-slate-900 dark:text-slate-100 placeholder:text-slate-400 dark:placeholder:text-slate-500 transition-colors"
 autoFocus
 />
 </div>
 </label>
 ...
 className="w-full h-11 pl-10 pr-12 border-2 border-slate-200 dark:border-slate-700 focus:border-emerald-400 outline-none text-sm bg-slate-50 dark:bg-slate-800 focus:bg-white dark:focus:bg-slate-900 text-slate-900 dark:text-slate-100 placeholder:text-slate-400 dark:placeholder:text-slate-500 transition-colors"
 />
 <button
 type="button"
 ...
 <button
 type="button"
 className="h-11 border-2 border-slate-200 dark:border-slate-700 hover:border-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/30 text-2xl transition-colors"
 title="Facebook"
 >
 📘
 </button>
 <button
 type="button"
 className="h-11 border-2 border-slate-200 dark:border-slate-700 hover:border-rose-400 hover:bg-rose-50 dark:hover:bg-rose-900/30 text-2xl transition-colors"
 title="Google"
 >
 🔴
 </button>
 <button
 type="button"
 className="h-11 border-2 border-slate-200 dark:border-slate-700 hover:border-sky-400 hover:bg-sky-50 dark:hover:bg-sky-900/30 text-2xl transition-colors"
 title="Telegram"
 >
 ✈️
 </button>
 ...
 {/* Demo hint */}
 <div className="mt-4 bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-900/40 p-3 text-xs text-amber-800 dark:text-amber-300">
