...
export default function Recharge() {
 ...
 className="w-full h-11 px-4 border-2 border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-slate-100 focus:border-emerald-400 outline-none text-sm"
 ...
 <li>Nội dung chuyển khoản: <code className="bg-white px-2 py-0.5 font-mono">NAP demo_user</code></li>
