...
export default function History() {
 ...
 <div
 key={s.label}
 className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-4"
 >
 ...
 <span
 className={`inline-block px-2.5 py-1 text-xs font-semibold bg-${o.statusColor}-100 text-${o.statusColor}-700`}
 >
 {o.status}
 </span>
 </td>
