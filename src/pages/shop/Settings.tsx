...
export default function Settings() {
 ...
 {/* RESET */}
 <div className="bg-rose-50 dark:bg-rose-950/30 border border-rose-200 dark:border-rose-900 p-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
 <div>
 ...
 className="px-5 h-10 bg-rose-500 hover:bg-rose-600 text-white text-sm font-bold whitespace-nowrap"
 >
 Khôi phục
 </button>
 </div>
...
function Section({
 ...
 return (
 <section className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-5 mb-5">
